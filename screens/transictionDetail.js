...
const TransictionDetail = ({navigation,route}) => {
    ...
    useEffect(() => {
        ...
        db.collection('expenses').doc(user).collection(date).doc(id).get().then( doc =>  {
                setDetail({...doc.data()});
        })
    ...
    return (
        <View style={styles.container}>
            <TouchableOpacity onPress={() => navigation.goBack()}>
                        <Text><Entypo name="cross" size={40} color="#404040" /></Text>
            </TouchableOpacity>
            <View style={styles.imageContainer}>
                <Image style={styles.congoImage} source={require('../assets/congratulations.png')} />
                <Text style={styles.congoHeading}>Congratulation!</Text>
                <Text style={styles.congoText}>Your transaction is added successfully to the app</Text>
            </View>
            <View style={styles.transDetails}>
              ...
              <View style={styles.transFlexDetail}>
                   ...
                   <View>
                        ...
                        <Text style={styles.detailText}>{moment(new Date()).format('DD-MMM-YYYY')}</Text>
                   </View>  
              </View>
              <View style={styles.transAmountDetail}>
                  ...
                  <View>
                      <TouchableOpacity style={styles.transEditButton}><Text style={styles.transEditText}>Edit</Text></TouchableOpacity>
                  </View>
              </View>
            </View>
